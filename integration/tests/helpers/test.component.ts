...
import { DebugLog } from '../../../lib/src/decorators/debug.decorator';
import { ErrorLog } from '../../../lib/src/decorators/error.decorator';
import { GroupCollapsed } from '../../../lib/src/decorators/groups/group-collapsed.decorator';
import { Group } from '../../../lib/src/decorators/groups/group.decorator';
import { InfoLog } from '../../../lib/src/decorators/info.decorator';
import { Log } from '../../../lib/src/decorators/log.decorator';
import { Logger } from '../../../lib/src/decorators/logger.decorator';
import { TimerLog } from '../../../lib/src/decorators/timer.decorator';
import { TraceLog } from '../../../lib/src/decorators/trace.decorator';
import { WarnLog } from '../../../lib/src/decorators/warn.decorator';
import { LogFn, LoggerLevel, TimerInfo } from '../../../lib/src/interfaces/logger.external';
import { Fn } from '../../../lib/src/interfaces/logger.internal';
